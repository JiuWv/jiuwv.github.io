...
/*    '        <li class="set-option">'+
    ...
    '        </li>'+
    '        <li class="set-option">'+
    '            <p class="set-title">E-MAIL</p>'+
    '            <p class="set-description">jiuvieto@gmail.com</p>'+
    '        </li>'+
    '        <li class="set-option">'+
    '            <p class="set-title">关于</p>'+
    '            <p class="set-description">BigLop原创，JiuWv修改自用</p>'+
    '        </li>'+
    '    </ul>'+
	...
	'                <a href="http://jiuwv.gitee.io/viaindex/"><img src="img/more.png"><p>主页收集</p><p>收集via浏览器定制主页</p></a>'+
